        ...
        <div class="card-body">            
            <form action="<?php echo site_url('donasi/save')?>" method="post">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" id="name" placeholder="Nama Barang" value=""/>
                  </div>
                  <div class="form-group">
                      <label for="int">Jumlah Barang<?php echo form_error('qty') ?></label>
                      <input type="number" class="form-control" name="qty" id="qty" placeholder="Qty" value="" ng-model="qty"/>
                  </div>
                  <div class="form-group">
                      <label for="int">Tanggal Pengambilan<?php echo form_error('Tanggal Pengambilan') ?></label>
                      <input type="date" class="form-control" name="date" id="address" value=""/>
                  </div>
                  <div class="form-group">
                      <label for="int">Lokasi Pengambilan<?php echo form_error('address') ?></label>
                      <input type="text" class="form-control" name="address" id="address" placeholder="Alamat Lengkap" value=""/>
                  </div>
